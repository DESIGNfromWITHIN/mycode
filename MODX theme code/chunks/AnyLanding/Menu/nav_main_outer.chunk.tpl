<nav id="navbarSupportedContent" class="collapse navbar-collapse [[+classnames]] [[++fred.anylanding.navbar_color]]  [[++fred.anylanding.navbar_font_size]] [[++fred.anylanding.navbar_item_spacing]]">
